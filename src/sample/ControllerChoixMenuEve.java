...
public class ControllerChoixMenuEve implements Initializable {
    ...
    public void Commander(MouseEvent mouseEvent)
    {
        ...
        Evenement eve= new Evenement(sample.Evenement.client, sample.Evenement.dateconsommation,LocalTime.now(), sample.Evenement.Nombre_de_personne,menu, sample.Evenement.thematique, sample.Evenement.type);
        Main.Esi.LesCommandesAtt.add(eve);//on ajoute la commande a la liste des commandes en attantes.
